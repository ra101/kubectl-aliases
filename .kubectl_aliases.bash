...
alias kvex='virtbin ssh --local-ssh-opts="-o UserKnownHostsFile=/dev/null" --local-ssh-opts="-o StrictHostKeyChecking=no" --local-ssh-opts="-o LogLevel=ERROR" '
...
alias kvst='virtbin start'
alias kvr='virtbin reset'
alias kvrr='virtbin restart'
alias kvsr='virtbin soft-reboot'
...
alias kvp='virtbin pause'
alias kvup='virtbin unpause'
alias kvsp='virtbin stop'
...
alias kevm='kubebin edit virtualmachine'
alias ksysevm='kubebin --namespace=kube-system edit virtualmachine'
alias kgvm='kubebin get virtualmachine'
alias ksysgvm='kubebin --namespace=kube-system get virtualmachine'
alias kdvm='kubebin describe virtualmachine'
alias ksysdvm='kubebin --namespace=kube-system describe virtualmachine'
alias krmvm='kubebin delete virtualmachine'
alias ksysrmvm='kubebin --namespace=kube-system delete virtualmachine'
alias kevmi='kubebin edit virtualmachineinstance'
alias ksysevmi='kubebin --namespace=kube-system edit virtualmachineinstance'
alias kgvmi='kubebin get virtualmachineinstance'
alias ksysgvmi='kubebin --namespace=kube-system get virtualmachineinstance'
alias kdvmi='kubebin describe virtualmachineinstance'
alias ksysdvmi='kubebin --namespace=kube-system describe virtualmachineinstance'
alias krmvmi='kubebin delete virtualmachineinstance'
alias ksysrmvmi='kubebin --namespace=kube-system delete virtualmachineinstance'
alias kevmim='kubebin edit virtualmachineinstancemigration'
alias ksysevmim='kubebin --namespace=kube-system edit virtualmachineinstancemigration'
alias kgvmim='kubebin get virtualmachineinstancemigration'
alias ksysgvmim='kubebin --namespace=kube-system get virtualmachineinstancemigration'
alias kdvmim='kubebin describe virtualmachineinstancemigration'
alias ksysdvmim='kubebin --namespace=kube-system describe virtualmachineinstancemigration'
alias krmvmim='kubebin delete virtualmachineinstancemigration'
alias ksysrmvmim='kubebin --namespace=kube-system delete virtualmachineinstancemigration'
...
alias kevmpool='kubebin edit virtualmachinepool'
alias ksysevmpool='kubebin --namespace=kube-system edit virtualmachinepool'
alias ksvmpool='kubebin scale virtualmachinepool'
alias ksyssvmpool='kubebin --namespace=kube-system scale virtualmachinepool'
alias kgvmpool='kubebin get virtualmachinepool'
alias ksysgvmpool='kubebin --namespace=kube-system get virtualmachinepool'
alias kdvmpool='kubebin describe virtualmachinepool'
alias ksysdvmpool='kubebin --namespace=kube-system describe virtualmachinepool'
alias krmvmpool='kubebin delete virtualmachinepool'
alias ksysrmvmpool='kubebin --namespace=kube-system delete virtualmachinepool'
...
alias keep='kubebin edit endpoints'
alias ksyseep='kubebin --namespace=kube-system edit endpoints'
alias kgep='kubebin get endpoints'
alias ksysgep='kubebin --namespace=kube-system get endpoints'
alias kdep='kubebin describe endpoints'
alias ksysdep='kubebin --namespace=kube-system describe endpoints'
alias krmep='kubebin delete endpoints'
alias ksysrmep='kubebin --namespace=kube-system delete endpoints'
alias keeps='kubebin edit endpointslices'
alias ksyseeps='kubebin --namespace=kube-system edit endpointslices'
alias kgeps='kubebin get endpointslices'
alias ksysgeps='kubebin --namespace=kube-system get endpointslices'
alias kdeps='kubebin describe endpointslices'
alias ksysdeps='kubebin --namespace=kube-system describe endpointslices'
alias krmeps='kubebin delete endpointslices'
alias ksysrmeps='kubebin --namespace=kube-system delete endpointslices'
...
alias keev='kubebin edit events'
alias ksyseev='kubebin --namespace=kube-system edit events'
alias kgev='kubebin get events'
alias ksysgev='kubebin --namespace=kube-system get events'
alias kdev='kubebin describe events'
alias ksysdev='kubebin --namespace=kube-system describe events'
alias krmev='kubebin delete events'
alias ksysrmev='kubebin --namespace=kube-system delete events'
...
alias kgvmoyaml='kubebin get virtualmachine -o=yaml'
alias ksysgvmoyaml='kubebin --namespace=kube-system get virtualmachine -o=yaml'
alias kgvmioyaml='kubebin get virtualmachineinstance -o=yaml'
alias ksysgvmioyaml='kubebin --namespace=kube-system get virtualmachineinstance -o=yaml'
alias kgvmimoyaml='kubebin get virtualmachineinstancemigration -o=yaml'
alias ksysgvmimoyaml='kubebin --namespace=kube-system get virtualmachineinstancemigration -o=yaml'
alias kgdepoyaml='kubebin get deployment -o=yaml'
alias ksysgdepoyaml='kubebin --namespace=kube-system get deployment -o=yaml'
alias kgvmpooloyaml='kubebin get virtualmachinepool -o=yaml'
alias ksysgvmpooloyaml='kubebin --namespace=kube-system get virtualmachinepool -o=yaml'
...
alias kgepoyaml='kubebin get endpoints -o=yaml'
alias ksysgepoyaml='kubebin --namespace=kube-system get endpoints -o=yaml'
alias kgepsoyaml='kubebin get endpointslices -o=yaml'
alias ksysgepsoyaml='kubebin --namespace=kube-system get endpointslices -o=yaml'
...
alias kgevoyaml='kubebin get events -o=yaml'
alias ksysgevoyaml='kubebin --namespace=kube-system get events -o=yaml'
...
alias kgvmowide='kubebin get virtualmachine -o=wide'
alias ksysgvmowide='kubebin --namespace=kube-system get virtualmachine -o=wide'
alias kgvmiowide='kubebin get virtualmachineinstance -o=wide'
alias ksysgvmiowide='kubebin --namespace=kube-system get virtualmachineinstance -o=wide'
alias kgvmimowide='kubebin get virtualmachineinstancemigration -o=wide'
alias ksysgvmimowide='kubebin --namespace=kube-system get virtualmachineinstancemigration -o=wide'
alias kgdepowide='kubebin get deployment -o=wide'
alias ksysgdepowide='kubebin --namespace=kube-system get deployment -o=wide'
alias kgvmpoolowide='kubebin get virtualmachinepool -o=wide'
alias ksysgvmpoolowide='kubebin --namespace=kube-system get virtualmachinepool -o=wide'
...
alias kgepowide='kubebin get endpoints -o=wide'
alias ksysgepowide='kubebin --namespace=kube-system get endpoints -o=wide'
alias kgepsowide='kubebin get endpointslices -o=wide'
alias ksysgepsowide='kubebin --namespace=kube-system get endpointslices -o=wide'
...
alias kgevowide='kubebin get events -o=wide'
alias ksysgevowide='kubebin --namespace=kube-system get events -o=wide'
...
alias kgvmojson='kubebin get virtualmachine -o=json'
alias ksysgvmojson='kubebin --namespace=kube-system get virtualmachine -o=json'
alias kgvmiojson='kubebin get virtualmachineinstance -o=json'
alias ksysgvmiojson='kubebin --namespace=kube-system get virtualmachineinstance -o=json'
alias kgvmimojson='kubebin get virtualmachineinstancemigration -o=json'
alias ksysgvmimojson='kubebin --namespace=kube-system get virtualmachineinstancemigration -o=json'
alias kgdepojson='kubebin get deployment -o=json'
alias ksysgdepojson='kubebin --namespace=kube-system get deployment -o=json'
alias kgvmpoolojson='kubebin get virtualmachinepool -o=json'
alias ksysgvmpoolojson='kubebin --namespace=kube-system get virtualmachinepool -o=json'
...
alias kgepojson='kubebin get endpoints -o=json'
alias ksysgepojson='kubebin --namespace=kube-system get endpoints -o=json'
alias kgepsojson='kubebin get endpointslices -o=json'
alias ksysgepsojson='kubebin --namespace=kube-system get endpointslices -o=json'
...
alias kgevojson='kubebin get events -o=json'
alias ksysgevojson='kubebin --namespace=kube-system get events -o=json'
...
alias kgvmall='kubebin get virtualmachine --all-namespaces'
alias kdvmall='kubebin describe virtualmachine --all-namespaces'
alias kgvmiall='kubebin get virtualmachineinstance --all-namespaces'
alias kdvmiall='kubebin describe virtualmachineinstance --all-namespaces'
alias kgvmimall='kubebin get virtualmachineinstancemigration --all-namespaces'
alias kdvmimall='kubebin describe virtualmachineinstancemigration --all-namespaces'
alias kgdepall='kubebin get deployment --all-namespaces'
alias kddepall='kubebin describe deployment --all-namespaces'
alias kgvmpoolall='kubebin get virtualmachinepool --all-namespaces'
alias kdvmpoolall='kubebin describe virtualmachinepool --all-namespaces'
...
alias kgepall='kubebin get endpoints --all-namespaces'
alias kdepall='kubebin describe endpoints --all-namespaces'
alias kgepsall='kubebin get endpointslices --all-namespaces'
alias kdepsall='kubebin describe endpointslices --all-namespaces'
...
alias kgevall='kubebin get events --all-namespaces'
alias kdevall='kubebin describe events --all-namespaces'
...
alias kgvmsl='kubebin get virtualmachine --show-labels'
alias ksysgvmsl='kubebin --namespace=kube-system get virtualmachine --show-labels'
alias kgvmisl='kubebin get virtualmachineinstance --show-labels'
alias ksysgvmisl='kubebin --namespace=kube-system get virtualmachineinstance --show-labels'
alias kgvmimsl='kubebin get virtualmachineinstancemigration --show-labels'
alias ksysgvmimsl='kubebin --namespace=kube-system get virtualmachineinstancemigration --show-labels'
...
alias kgvmpoolsl='kubebin get virtualmachinepool --show-labels'
alias ksysgvmpoolsl='kubebin --namespace=kube-system get virtualmachinepool --show-labels'
...
alias kgepsl='kubebin get endpoints --show-labels'
alias ksysgepsl='kubebin --namespace=kube-system get endpoints --show-labels'
alias kgepssl='kubebin get endpointslices --show-labels'
alias ksysgepssl='kubebin --namespace=kube-system get endpointslices --show-labels'
...
alias kgevsl='kubebin get events --show-labels'
alias ksysgevsl='kubebin --namespace=kube-system get events --show-labels'
...
alias krmvmall='kubebin delete virtualmachine --all'
alias ksysrmvmall='kubebin --namespace=kube-system delete virtualmachine --all'
alias krmvmiall='kubebin delete virtualmachineinstance --all'
alias ksysrmvmiall='kubebin --namespace=kube-system delete virtualmachineinstance --all'
alias krmvmimall='kubebin delete virtualmachineinstancemigration --all'
alias ksysrmvmimall='kubebin --namespace=kube-system delete virtualmachineinstancemigration --all'
alias krmdepall='kubebin delete deployment --all'
alias ksysrmdepall='kubebin --namespace=kube-system delete deployment --all'
alias krmvmpoolall='kubebin delete virtualmachinepool --all'
alias ksysrmvmpoolall='kubebin --namespace=kube-system delete virtualmachinepool --all'
...
alias krmepall='kubebin delete endpoints --all'
alias ksysrmepall='kubebin --namespace=kube-system delete endpoints --all'
alias krmepsall='kubebin delete endpointslices --all'
alias ksysrmepsall='kubebin --namespace=kube-system delete endpointslices --all'
...
alias krmevall='kubebin delete events --all'
alias ksysrmevall='kubebin --namespace=kube-system delete events --all'
...
alias kgvmw='kubebin get virtualmachine --watch'
alias ksysgvmw='kubebin --namespace=kube-system get virtualmachine --watch'
alias kgvmiw='kubebin get virtualmachineinstance --watch'
alias ksysgvmiw='kubebin --namespace=kube-system get virtualmachineinstance --watch'
alias kgvmimw='kubebin get virtualmachineinstancemigration --watch'
alias ksysgvmimw='kubebin --namespace=kube-system get virtualmachineinstancemigration --watch'
alias kgdepw='kubebin get deployment --watch'
alias ksysgdepw='kubebin --namespace=kube-system get deployment --watch'
alias kgvmpoolw='kubebin get virtualmachinepool --watch'
alias ksysgvmpoolw='kubebin --namespace=kube-system get virtualmachinepool --watch'
...
alias kgepw='kubebin get endpoints --watch'
alias ksysgepw='kubebin --namespace=kube-system get endpoints --watch'
alias kgepsw='kubebin get endpointslices --watch'
alias ksysgepsw='kubebin --namespace=kube-system get endpointslices --watch'
...
alias kgevw='kubebin get events --watch'
alias ksysgevw='kubebin --namespace=kube-system get events --watch'
alias kgoyamlall='kubebin get -o=yaml --all-namespaces'
alias kgpooyamlall='kubebin get pods -o=yaml --all-namespaces'
alias kgvmoyamlall='kubebin get virtualmachine -o=yaml --all-namespaces'
alias kgvmioyamlall='kubebin get virtualmachineinstance -o=yaml --all-namespaces'
alias kgvmimoyamlall='kubebin get virtualmachineinstancemigration -o=yaml --all-namespaces'
alias kgdepoyamlall='kubebin get deployment -o=yaml --all-namespaces'
alias kgvmpooloyamlall='kubebin get virtualmachinepool -o=yaml --all-namespaces'
...
alias kgepoyamlall='kubebin get endpoints -o=yaml --all-namespaces'
alias kgepsoyamlall='kubebin get endpointslices -o=yaml --all-namespaces'
...
alias kgevoyamlall='kubebin get events -o=yaml --all-namespaces'
alias kgalloyaml='kubebin get --all-namespaces -o=yaml'
alias kgpoalloyaml='kubebin get pods --all-namespaces -o=yaml'
alias kgvmalloyaml='kubebin get virtualmachine --all-namespaces -o=yaml'
alias kgvmialloyaml='kubebin get virtualmachineinstance --all-namespaces -o=yaml'
alias kgvmimalloyaml='kubebin get virtualmachineinstancemigration --all-namespaces -o=yaml'
alias kgdepalloyaml='kubebin get deployment --all-namespaces -o=yaml'
alias kgvmpoolalloyaml='kubebin get virtualmachinepool --all-namespaces -o=yaml'
...
alias kgepalloyaml='kubebin get endpoints --all-namespaces -o=yaml'
alias kgepsalloyaml='kubebin get endpointslices --all-namespaces -o=yaml'
...
alias kgevalloyaml='kubebin get events --all-namespaces -o=yaml'
alias kgowideall='kubebin get -o=wide --all-namespaces'
alias kgpoowideall='kubebin get pods -o=wide --all-namespaces'
alias kgvmowideall='kubebin get virtualmachine -o=wide --all-namespaces'
alias kgvmiowideall='kubebin get virtualmachineinstance -o=wide --all-namespaces'
alias kgvmimowideall='kubebin get virtualmachineinstancemigration -o=wide --all-namespaces'
alias kgdepowideall='kubebin get deployment -o=wide --all-namespaces'
alias kgvmpoolowideall='kubebin get virtualmachinepool -o=wide --all-namespaces'
...
alias kgepowideall='kubebin get endpoints -o=wide --all-namespaces'
alias kgepsowideall='kubebin get endpointslices -o=wide --all-namespaces'
...
alias kgevowideall='kubebin get events -o=wide --all-namespaces'
alias kgallowide='kubebin get --all-namespaces -o=wide'
alias kgpoallowide='kubebin get pods --all-namespaces -o=wide'
alias kgvmallowide='kubebin get virtualmachine --all-namespaces -o=wide'
alias kgvmiallowide='kubebin get virtualmachineinstance --all-namespaces -o=wide'
alias kgvmimallowide='kubebin get virtualmachineinstancemigration --all-namespaces -o=wide'
alias kgdepallowide='kubebin get deployment --all-namespaces -o=wide'
alias kgvmpoolallowide='kubebin get virtualmachinepool --all-namespaces -o=wide'
...
alias kgepallowide='kubebin get endpoints --all-namespaces -o=wide'
alias kgepsallowide='kubebin get endpointslices --all-namespaces -o=wide'
...
alias kgevallowide='kubebin get events --all-namespaces -o=wide'
...
alias kgvmowidesl='kubebin get virtualmachine -o=wide --show-labels'
alias ksysgvmowidesl='kubebin --namespace=kube-system get virtualmachine -o=wide --show-labels'
alias kgvmiowidesl='kubebin get virtualmachineinstance -o=wide --show-labels'
alias ksysgvmiowidesl='kubebin --namespace=kube-system get virtualmachineinstance -o=wide --show-labels'
alias kgvmimowidesl='kubebin get virtualmachineinstancemigration -o=wide --show-labels'
alias ksysgvmimowidesl='kubebin --namespace=kube-system get virtualmachineinstancemigration -o=wide --show-labels'
...
alias kgvmpoolowidesl='kubebin get virtualmachinepool -o=wide --show-labels'
alias ksysgvmpoolowidesl='kubebin --namespace=kube-system get virtualmachinepool -o=wide --show-labels'
...
alias kgepowidesl='kubebin get endpoints -o=wide --show-labels'
alias ksysgepowidesl='kubebin --namespace=kube-system get endpoints -o=wide --show-labels'
alias kgepsowidesl='kubebin get endpointslices -o=wide --show-labels'
alias ksysgepsowidesl='kubebin --namespace=kube-system get endpointslices -o=wide --show-labels'
...
alias kgevowidesl='kubebin get events -o=wide --show-labels'
alias ksysgevowidesl='kubebin --namespace=kube-system get events -o=wide --show-labels'
...
alias kgvmslowide='kubebin get virtualmachine --show-labels -o=wide'
alias ksysgvmslowide='kubebin --namespace=kube-system get virtualmachine --show-labels -o=wide'
alias kgvmislowide='kubebin get virtualmachineinstance --show-labels -o=wide'
alias ksysgvmislowide='kubebin --namespace=kube-system get virtualmachineinstance --show-labels -o=wide'
alias kgvmimslowide='kubebin get virtualmachineinstancemigration --show-labels -o=wide'
alias ksysgvmimslowide='kubebin --namespace=kube-system get virtualmachineinstancemigration --show-labels -o=wide'
...
alias kgvmpoolslowide='kubebin get virtualmachinepool --show-labels -o=wide'
alias ksysgvmpoolslowide='kubebin --namespace=kube-system get virtualmachinepool --show-labels -o=wide'
...
alias kgepslowide='kubebin get endpoints --show-labels -o=wide'
alias ksysgepslowide='kubebin --namespace=kube-system get endpoints --show-labels -o=wide'
alias kgepsslowide='kubebin get endpointslices --show-labels -o=wide'
alias ksysgepsslowide='kubebin --namespace=kube-system get endpointslices --show-labels -o=wide'
...
alias kgevslowide='kubebin get events --show-labels -o=wide'
alias ksysgevslowide='kubebin --namespace=kube-system get events --show-labels -o=wide'
alias kgojsonall='kubebin get -o=json --all-namespaces'
alias kgpoojsonall='kubebin get pods -o=json --all-namespaces'
alias kgvmojsonall='kubebin get virtualmachine -o=json --all-namespaces'
alias kgvmiojsonall='kubebin get virtualmachineinstance -o=json --all-namespaces'
alias kgvmimojsonall='kubebin get virtualmachineinstancemigration -o=json --all-namespaces'
alias kgdepojsonall='kubebin get deployment -o=json --all-namespaces'
alias kgvmpoolojsonall='kubebin get virtualmachinepool -o=json --all-namespaces'
...
alias kgepojsonall='kubebin get endpoints -o=json --all-namespaces'
alias kgepsojsonall='kubebin get endpointslices -o=json --all-namespaces'
...
alias kgevojsonall='kubebin get events -o=json --all-namespaces'
alias kgallojson='kubebin get --all-namespaces -o=json'
alias kgpoallojson='kubebin get pods --all-namespaces -o=json'
alias kgvmallojson='kubebin get virtualmachine --all-namespaces -o=json'
alias kgvmiallojson='kubebin get virtualmachineinstance --all-namespaces -o=json'
alias kgvmimallojson='kubebin get virtualmachineinstancemigration --all-namespaces -o=json'
alias kgdepallojson='kubebin get deployment --all-namespaces -o=json'
alias kgvmpoolallojson='kubebin get virtualmachinepool --all-namespaces -o=json'
...
alias kgepallojson='kubebin get endpoints --all-namespaces -o=json'
alias kgepsallojson='kubebin get endpointslices --all-namespaces -o=json'
...
alias kgevallojson='kubebin get events --all-namespaces -o=json'
alias kgallsl='kubebin get --all-namespaces --show-labels'
alias kgpoallsl='kubebin get pods --all-namespaces --show-labels'
alias kgvmallsl='kubebin get virtualmachine --all-namespaces --show-labels'
alias kgvmiallsl='kubebin get virtualmachineinstance --all-namespaces --show-labels'
alias kgvmimallsl='kubebin get virtualmachineinstancemigration --all-namespaces --show-labels'
alias kgdepallsl='kubebin get deployment --all-namespaces --show-labels'
alias kgvmpoolallsl='kubebin get virtualmachinepool --all-namespaces --show-labels'
...
alias kgepallsl='kubebin get endpoints --all-namespaces --show-labels'
alias kgepsallsl='kubebin get endpointslices --all-namespaces --show-labels'
...
alias kgevallsl='kubebin get events --all-namespaces --show-labels'
alias kgslall='kubebin get --show-labels --all-namespaces'
alias kgposlall='kubebin get pods --show-labels --all-namespaces'
alias kgvmslall='kubebin get virtualmachine --show-labels --all-namespaces'
alias kgvmislall='kubebin get virtualmachineinstance --show-labels --all-namespaces'
alias kgvmimslall='kubebin get virtualmachineinstancemigration --show-labels --all-namespaces'
alias kgdepslall='kubebin get deployment --show-labels --all-namespaces'
alias kgvmpoolslall='kubebin get virtualmachinepool --show-labels --all-namespaces'
...
alias kgepslall='kubebin get endpoints --show-labels --all-namespaces'
alias kgepsslall='kubebin get endpointslices --show-labels --all-namespaces'
...
alias kgevslall='kubebin get events --show-labels --all-namespaces'
alias kgallw='kubebin get --all-namespaces --watch'
alias kgpoallw='kubebin get pods --all-namespaces --watch'
alias kgvmallw='kubebin get virtualmachine --all-namespaces --watch'
alias kgvmiallw='kubebin get virtualmachineinstance --all-namespaces --watch'
alias kgvmimallw='kubebin get virtualmachineinstancemigration --all-namespaces --watch'
alias kgdepallw='kubebin get deployment --all-namespaces --watch'
alias kgvmpoolallw='kubebin get virtualmachinepool --all-namespaces --watch'
...
alias kgepallw='kubebin get endpoints --all-namespaces --watch'
alias kgepsallw='kubebin get endpointslices --all-namespaces --watch'
...
alias kgevallw='kubebin get events --all-namespaces --watch'
alias kgwall='kubebin get --watch --all-namespaces'
alias kgpowall='kubebin get pods --watch --all-namespaces'
alias kgvmwall='kubebin get virtualmachine --watch --all-namespaces'
alias kgvmiwall='kubebin get virtualmachineinstance --watch --all-namespaces'
alias kgvmimwall='kubebin get virtualmachineinstancemigration --watch --all-namespaces'
alias kgdepwall='kubebin get deployment --watch --all-namespaces'
alias kgvmpoolwall='kubebin get virtualmachinepool --watch --all-namespaces'
...
alias kgepwall='kubebin get endpoints --watch --all-namespaces'
alias kgepswall='kubebin get endpointslices --watch --all-namespaces'
...
alias kgevwall='kubebin get events --watch --all-namespaces'
...
alias kgvmslw='kubebin get virtualmachine --show-labels --watch'
alias ksysgvmslw='kubebin --namespace=kube-system get virtualmachine --show-labels --watch'
alias kgvmislw='kubebin get virtualmachineinstance --show-labels --watch'
alias ksysgvmislw='kubebin --namespace=kube-system get virtualmachineinstance --show-labels --watch'
alias kgvmimslw='kubebin get virtualmachineinstancemigration --show-labels --watch'
alias ksysgvmimslw='kubebin --namespace=kube-system get virtualmachineinstancemigration --show-labels --watch'
...
alias kgvmpoolslw='kubebin get virtualmachinepool --show-labels --watch'
alias ksysgvmpoolslw='kubebin --namespace=kube-system get virtualmachinepool --show-labels --watch'
...
alias kgepslw='kubebin get endpoints --show-labels --watch'
alias ksysgepslw='kubebin --namespace=kube-system get endpoints --show-labels --watch'
alias kgepsslw='kubebin get endpointslices --show-labels --watch'
alias ksysgepsslw='kubebin --namespace=kube-system get endpointslices --show-labels --watch'
...
alias kgevslw='kubebin get events --show-labels --watch'
alias ksysgevslw='kubebin --namespace=kube-system get events --show-labels --watch'
...
alias kgvmwsl='kubebin get virtualmachine --watch --show-labels'
alias ksysgvmwsl='kubebin --namespace=kube-system get virtualmachine --watch --show-labels'
alias kgvmiwsl='kubebin get virtualmachineinstance --watch --show-labels'
alias ksysgvmiwsl='kubebin --namespace=kube-system get virtualmachineinstance --watch --show-labels'
alias kgvmimwsl='kubebin get virtualmachineinstancemigration --watch --show-labels'
alias ksysgvmimwsl='kubebin --namespace=kube-system get virtualmachineinstancemigration --watch --show-labels'
...
alias kgvmpoolwsl='kubebin get virtualmachinepool --watch --show-labels'
alias ksysgvmpoolwsl='kubebin --namespace=kube-system get virtualmachinepool --watch --show-labels'
...
alias kgepwsl='kubebin get endpoints --watch --show-labels'
alias ksysgepwsl='kubebin --namespace=kube-system get endpoints --watch --show-labels'
alias kgepswsl='kubebin get endpointslices --watch --show-labels'
alias ksysgepswsl='kubebin --namespace=kube-system get endpointslices --watch --show-labels'
...
alias kgevwsl='kubebin get events --watch --show-labels'
alias ksysgevwsl='kubebin --namespace=kube-system get events --watch --show-labels'
...
alias kgvmowideallsl='kubebin get virtualmachine -o=wide --all-namespaces --show-labels'
alias kgvmiowideallsl='kubebin get virtualmachineinstance -o=wide --all-namespaces --show-labels'
alias kgvmimowideallsl='kubebin get virtualmachineinstancemigration -o=wide --all-namespaces --show-labels'
alias kgdepowideallsl='kubebin get deployment -o=wide --all-namespaces --show-labels'
alias kgvmpoolowideallsl='kubebin get virtualmachinepool -o=wide --all-namespaces --show-labels'
...
alias kgepowideallsl='kubebin get endpoints -o=wide --all-namespaces --show-labels'
alias kgepsowideallsl='kubebin get endpointslices -o=wide --all-namespaces --show-labels'
...
alias kgevowideallsl='kubebin get events -o=wide --all-namespaces --show-labels'
...
alias kgvmowideslall='kubebin get virtualmachine -o=wide --show-labels --all-namespaces'
alias kgvmiowideslall='kubebin get virtualmachineinstance -o=wide --show-labels --all-namespaces'
alias kgvmimowideslall='kubebin get virtualmachineinstancemigration -o=wide --show-labels --all-namespaces'
alias kgdepowideslall='kubebin get deployment -o=wide --show-labels --all-namespaces'
alias kgvmpoolowideslall='kubebin get virtualmachinepool -o=wide --show-labels --all-namespaces'
...
alias kgepowideslall='kubebin get endpoints -o=wide --show-labels --all-namespaces'
alias kgepsowideslall='kubebin get endpointslices -o=wide --show-labels --all-namespaces'
...
alias kgevowideslall='kubebin get events -o=wide --show-labels --all-namespaces'
...
alias kgvmallowidesl='kubebin get virtualmachine --all-namespaces -o=wide --show-labels'
alias kgvmiallowidesl='kubebin get virtualmachineinstance --all-namespaces -o=wide --show-labels'
alias kgvmimallowidesl='kubebin get virtualmachineinstancemigration --all-namespaces -o=wide --show-labels'
alias kgdepallowidesl='kubebin get deployment --all-namespaces -o=wide --show-labels'
alias kgvmpoolallowidesl='kubebin get virtualmachinepool --all-namespaces -o=wide --show-labels'
...
alias kgepallowidesl='kubebin get endpoints --all-namespaces -o=wide --show-labels'
alias kgepsallowidesl='kubebin get endpointslices --all-namespaces -o=wide --show-labels'
...
alias kgevallowidesl='kubebin get events --all-namespaces -o=wide --show-labels'
...
alias kgvmallslowide='kubebin get virtualmachine --all-namespaces --show-labels -o=wide'
alias kgvmiallslowide='kubebin get virtualmachineinstance --all-namespaces --show-labels -o=wide'
alias kgvmimallslowide='kubebin get virtualmachineinstancemigration --all-namespaces --show-labels -o=wide'
alias kgdepallslowide='kubebin get deployment --all-namespaces --show-labels -o=wide'
alias kgvmpoolallslowide='kubebin get virtualmachinepool --all-namespaces --show-labels -o=wide'
...
alias kgepallslowide='kubebin get endpoints --all-namespaces --show-labels -o=wide'
alias kgepsallslowide='kubebin get endpointslices --all-namespaces --show-labels -o=wide'
...
alias kgevallslowide='kubebin get events --all-namespaces --show-labels -o=wide'
...
alias kgvmslowideall='kubebin get virtualmachine --show-labels -o=wide --all-namespaces'
alias kgvmislowideall='kubebin get virtualmachineinstance --show-labels -o=wide --all-namespaces'
alias kgvmimslowideall='kubebin get virtualmachineinstancemigration --show-labels -o=wide --all-namespaces'
alias kgdepslowideall='kubebin get deployment --show-labels -o=wide --all-namespaces'
alias kgvmpoolslowideall='kubebin get virtualmachinepool --show-labels -o=wide --all-namespaces'
...
alias kgepslowideall='kubebin get endpoints --show-labels -o=wide --all-namespaces'
alias kgepsslowideall='kubebin get endpointslices --show-labels -o=wide --all-namespaces'
...
alias kgevslowideall='kubebin get events --show-labels -o=wide --all-namespaces'
...
alias kgvmslallowide='kubebin get virtualmachine --show-labels --all-namespaces -o=wide'
alias kgvmislallowide='kubebin get virtualmachineinstance --show-labels --all-namespaces -o=wide'
alias kgvmimslallowide='kubebin get virtualmachineinstancemigration --show-labels --all-namespaces -o=wide'
alias kgdepslallowide='kubebin get deployment --show-labels --all-namespaces -o=wide'
alias kgvmpoolslallowide='kubebin get virtualmachinepool --show-labels --all-namespaces -o=wide'
...
alias kgepslallowide='kubebin get endpoints --show-labels --all-namespaces -o=wide'
alias kgepsslallowide='kubebin get endpointslices --show-labels --all-namespaces -o=wide'
...
alias kgevslallowide='kubebin get events --show-labels --all-namespaces -o=wide'
...
alias kgvmallslw='kubebin get virtualmachine --all-namespaces --show-labels --watch'
alias kgvmiallslw='kubebin get virtualmachineinstance --all-namespaces --show-labels --watch'
alias kgvmimallslw='kubebin get virtualmachineinstancemigration --all-namespaces --show-labels --watch'
alias kgdepallslw='kubebin get deployment --all-namespaces --show-labels --watch'
alias kgvmpoolallslw='kubebin get virtualmachinepool --all-namespaces --show-labels --watch'
...
alias kgepallslw='kubebin get endpoints --all-namespaces --show-labels --watch'
alias kgepsallslw='kubebin get endpointslices --all-namespaces --show-labels --watch'
...
alias kgevallslw='kubebin get events --all-namespaces --show-labels --watch'
...
alias kgvmallwsl='kubebin get virtualmachine --all-namespaces --watch --show-labels'
alias kgvmiallwsl='kubebin get virtualmachineinstance --all-namespaces --watch --show-labels'
alias kgvmimallwsl='kubebin get virtualmachineinstancemigration --all-namespaces --watch --show-labels'
alias kgdepallwsl='kubebin get deployment --all-namespaces --watch --show-labels'
alias kgvmpoolallwsl='kubebin get virtualmachinepool --all-namespaces --watch --show-labels'
...
alias kgepallwsl='kubebin get endpoints --all-namespaces --watch --show-labels'
alias kgepsallwsl='kubebin get endpointslices --all-namespaces --watch --show-labels'
...
alias kgevallwsl='kubebin get events --all-namespaces --watch --show-labels'
...
alias kgvmslallw='kubebin get virtualmachine --show-labels --all-namespaces --watch'
alias kgvmislallw='kubebin get virtualmachineinstance --show-labels --all-namespaces --watch'
alias kgvmimslallw='kubebin get virtualmachineinstancemigration --show-labels --all-namespaces --watch'
alias kgdepslallw='kubebin get deployment --show-labels --all-namespaces --watch'
alias kgvmpoolslallw='kubebin get virtualmachinepool --show-labels --all-namespaces --watch'
...
alias kgepslallw='kubebin get endpoints --show-labels --all-namespaces --watch'
alias kgepsslallw='kubebin get endpointslices --show-labels --all-namespaces --watch'
...
alias kgevslallw='kubebin get events --show-labels --all-namespaces --watch'
...
alias kgvmslwall='kubebin get virtualmachine --show-labels --watch --all-namespaces'
alias kgvmislwall='kubebin get virtualmachineinstance --show-labels --watch --all-namespaces'
alias kgvmimslwall='kubebin get virtualmachineinstancemigration --show-labels --watch --all-namespaces'
alias kgdepslwall='kubebin get deployment --show-labels --watch --all-namespaces'
alias kgvmpoolslwall='kubebin get virtualmachinepool --show-labels --watch --all-namespaces'
...
alias kgepslwall='kubebin get endpoints --show-labels --watch --all-namespaces'
alias kgepsslwall='kubebin get endpointslices --show-labels --watch --all-namespaces'
...
alias kgevslwall='kubebin get events --show-labels --watch --all-namespaces'
...
alias kgvmwallsl='kubebin get virtualmachine --watch --all-namespaces --show-labels'
alias kgvmiwallsl='kubebin get virtualmachineinstance --watch --all-namespaces --show-labels'
alias kgvmimwallsl='kubebin get virtualmachineinstancemigration --watch --all-namespaces --show-labels'
alias kgdepwallsl='kubebin get deployment --watch --all-namespaces --show-labels'
alias kgvmpoolwallsl='kubebin get virtualmachinepool --watch --all-namespaces --show-labels'
...
alias kgepwallsl='kubebin get endpoints --watch --all-namespaces --show-labels'
alias kgepswallsl='kubebin get endpointslices --watch --all-namespaces --show-labels'
...
alias kgevwallsl='kubebin get events --watch --all-namespaces --show-labels'
...
alias kgvmwslall='kubebin get virtualmachine --watch --show-labels --all-namespaces'
alias kgvmiwslall='kubebin get virtualmachineinstance --watch --show-labels --all-namespaces'
alias kgvmimwslall='kubebin get virtualmachineinstancemigration --watch --show-labels --all-namespaces'
alias kgdepwslall='kubebin get deployment --watch --show-labels --all-namespaces'
alias kgvmpoolwslall='kubebin get virtualmachinepool --watch --show-labels --all-namespaces'
...
alias kgepwslall='kubebin get endpoints --watch --show-labels --all-namespaces'
alias kgepswslall='kubebin get endpointslices --watch --show-labels --all-namespaces'
...
alias kgevwslall='kubebin get events --watch --show-labels --all-namespaces'
...
alias kevmn='kubebin edit virtualmachine --namespace'
alias kgvmn='kubebin get virtualmachine --namespace'
alias kdvmn='kubebin describe virtualmachine --namespace'
alias krmvmn='kubebin delete virtualmachine --namespace'
alias kevmin='kubebin edit virtualmachineinstance --namespace'
alias kgvmin='kubebin get virtualmachineinstance --namespace'
alias kdvmin='kubebin describe virtualmachineinstance --namespace'
alias krmvmin='kubebin delete virtualmachineinstance --namespace'
alias kevmimn='kubebin edit virtualmachineinstancemigration --namespace'
alias kgvmimn='kubebin get virtualmachineinstancemigration --namespace'
alias kdvmimn='kubebin describe virtualmachineinstancemigration --namespace'
alias krmvmimn='kubebin delete virtualmachineinstancemigration --namespace'
...
alias kevmpooln='kubebin edit virtualmachinepool --namespace'
alias ksvmpooln='kubebin scale virtualmachinepool --namespace'
alias kgvmpooln='kubebin get virtualmachinepool --namespace'
alias kdvmpooln='kubebin describe virtualmachinepool --namespace'
alias krmvmpooln='kubebin delete virtualmachinepool --namespace'
...
alias keepn='kubebin edit endpoints --namespace'
alias kgepn='kubebin get endpoints --namespace'
alias kdepn='kubebin describe endpoints --namespace'
alias krmepn='kubebin delete endpoints --namespace'
alias keepsn='kubebin edit endpointslices --namespace'
alias kgepsn='kubebin get endpointslices --namespace'
alias kdepsn='kubebin describe endpointslices --namespace'
alias krmepsn='kubebin delete endpointslices --namespace'
...
alias keevn='kubebin edit events --namespace'
alias kgevn='kubebin get events --namespace'
alias kdevn='kubebin describe events --namespace'
alias krmevn='kubebin delete events --namespace'
alias kgoyamln='kubebin get -o=yaml --namespace'
alias kgpooyamln='kubebin get pods -o=yaml --namespace'
alias kgvmoyamln='kubebin get virtualmachine -o=yaml --namespace'
alias kgvmioyamln='kubebin get virtualmachineinstance -o=yaml --namespace'
alias kgvmimoyamln='kubebin get virtualmachineinstancemigration -o=yaml --namespace'
alias kgdepoyamln='kubebin get deployment -o=yaml --namespace'
alias kgvmpooloyamln='kubebin get virtualmachinepool -o=yaml --namespace'
...
alias kgepoyamln='kubebin get endpoints -o=yaml --namespace'
alias kgepsoyamln='kubebin get endpointslices -o=yaml --namespace'
...
alias kgevoyamln='kubebin get events -o=yaml --namespace'
alias kgowiden='kubebin get -o=wide --namespace'
alias kgpoowiden='kubebin get pods -o=wide --namespace'
alias kgvmowiden='kubebin get virtualmachine -o=wide --namespace'
alias kgvmiowiden='kubebin get virtualmachineinstance -o=wide --namespace'
alias kgvmimowiden='kubebin get virtualmachineinstancemigration -o=wide --namespace'
alias kgdepowiden='kubebin get deployment -o=wide --namespace'
alias kgvmpoolowiden='kubebin get virtualmachinepool -o=wide --namespace'
...
alias kgepowiden='kubebin get endpoints -o=wide --namespace'
alias kgepsowiden='kubebin get endpointslices -o=wide --namespace'
...
alias kgevowiden='kubebin get events -o=wide --namespace'
alias kgojsonn='kubebin get -o=json --namespace'
alias kgpoojsonn='kubebin get pods -o=json --namespace'
alias kgvmojsonn='kubebin get virtualmachine -o=json --namespace'
alias kgvmiojsonn='kubebin get virtualmachineinstance -o=json --namespace'
alias kgvmimojsonn='kubebin get virtualmachineinstancemigration -o=json --namespace'
alias kgdepojsonn='kubebin get deployment -o=json --namespace'
alias kgvmpoolojsonn='kubebin get virtualmachinepool -o=json --namespace'
...
alias kgepojsonn='kubebin get endpoints -o=json --namespace'
alias kgepsojsonn='kubebin get endpointslices -o=json --namespace'
...
alias kgevojsonn='kubebin get events -o=json --namespace'
alias kgsln='kubebin get --show-labels --namespace'
alias kgposln='kubebin get pods --show-labels --namespace'
alias kgvmsln='kubebin get virtualmachine --show-labels --namespace'
alias kgvmisln='kubebin get virtualmachineinstance --show-labels --namespace'
alias kgvmimsln='kubebin get virtualmachineinstancemigration --show-labels --namespace'
alias kgdepsln='kubebin get deployment --show-labels --namespace'
alias kgvmpoolsln='kubebin get virtualmachinepool --show-labels --namespace'
...
alias kgepsln='kubebin get endpoints --show-labels --namespace'
alias kgepssln='kubebin get endpointslices --show-labels --namespace'
...
alias kgevsln='kubebin get events --show-labels --namespace'
alias kgwn='kubebin get --watch --namespace'
alias kgpown='kubebin get pods --watch --namespace'
alias kgvmwn='kubebin get virtualmachine --watch --namespace'
alias kgvmiwn='kubebin get virtualmachineinstance --watch --namespace'
alias kgvmimwn='kubebin get virtualmachineinstancemigration --watch --namespace'
alias kgdepwn='kubebin get deployment --watch --namespace'
alias kgvmpoolwn='kubebin get virtualmachinepool --watch --namespace'
...
alias kgepwn='kubebin get endpoints --watch --namespace'
alias kgepswn='kubebin get endpointslices --watch --namespace'
...
alias kgevwn='kubebin get events --watch --namespace'
...
alias kgvmowidesln='kubebin get virtualmachine -o=wide --show-labels --namespace'
alias kgvmiowidesln='kubebin get virtualmachineinstance -o=wide --show-labels --namespace'
alias kgvmimowidesln='kubebin get virtualmachineinstancemigration -o=wide --show-labels --namespace'
alias kgdepowidesln='kubebin get deployment -o=wide --show-labels --namespace'
alias kgvmpoolowidesln='kubebin get virtualmachinepool -o=wide --show-labels --namespace'
...
alias kgepowidesln='kubebin get endpoints -o=wide --show-labels --namespace'
alias kgepsowidesln='kubebin get endpointslices -o=wide --show-labels --namespace'
...
alias kgevowidesln='kubebin get events -o=wide --show-labels --namespace'
...
alias kgvmslowiden='kubebin get virtualmachine --show-labels -o=wide --namespace'
alias kgvmislowiden='kubebin get virtualmachineinstance --show-labels -o=wide --namespace'
alias kgvmimslowiden='kubebin get virtualmachineinstancemigration --show-labels -o=wide --namespace'
alias kgdepslowiden='kubebin get deployment --show-labels -o=wide --namespace'
alias kgvmpoolslowiden='kubebin get virtualmachinepool --show-labels -o=wide --namespace'
...
alias kgepslowiden='kubebin get endpoints --show-labels -o=wide --namespace'
alias kgepsslowiden='kubebin get endpointslices --show-labels -o=wide --namespace'
...
alias kgevslowiden='kubebin get events --show-labels -o=wide --namespace'
alias kgslwn='kubebin get --show-labels --watch --namespace'
alias kgposlwn='kubebin get pods --show-labels --watch --namespace'
alias kgvmslwn='kubebin get virtualmachine --show-labels --watch --namespace'
alias kgvmislwn='kubebin get virtualmachineinstance --show-labels --watch --namespace'
alias kgvmimslwn='kubebin get virtualmachineinstancemigration --show-labels --watch --namespace'
alias kgdepslwn='kubebin get deployment --show-labels --watch --namespace'
alias kgvmpoolslwn='kubebin get virtualmachinepool --show-labels --watch --namespace'
...
alias kgepslwn='kubebin get endpoints --show-labels --watch --namespace'
alias kgepsslwn='kubebin get endpointslices --show-labels --watch --namespace'
...
alias kgevslwn='kubebin get events --show-labels --watch --namespace'
alias kgwsln='kubebin get --watch --show-labels --namespace'
alias kgpowsln='kubebin get pods --watch --show-labels --namespace'
alias kgvmwsln='kubebin get virtualmachine --watch --show-labels --namespace'
alias kgvmiwsln='kubebin get virtualmachineinstance --watch --show-labels --namespace'
alias kgvmimwsln='kubebin get virtualmachineinstancemigration --watch --show-labels --namespace'
alias kgdepwsln='kubebin get deployment --watch --show-labels --namespace'
alias kgvmpoolwsln='kubebin get virtualmachinepool --watch --show-labels --namespace'
...
alias kgepwsln='kubebin get endpoints --watch --show-labels --namespace'
alias kgepswsln='kubebin get endpointslices --watch --show-labels --namespace'
...
alias kgevwsln='kubebin get events --watch --show-labels --namespace'
